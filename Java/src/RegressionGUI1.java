...
public class RegressionGUI1 {
    ...
    public static void runBar()
    {
		...
		while( i<=99)
        {
			  try{ RegressionGUI1.progressBar.setValue(i);//Setting value of Progress Bar
			  RegressionGUI1.message.setText("LOADING "+Integer.toString(i)+"%");//Setting text of theSplashScreen.message JLabel 
			  if (i==99)
    ...
    {
    	RegressionGUI1.progressBar.setValue(100);
    	try {
    	}catch(Exception e){ e.printStackTrace(); }
    	 frame.dispose();
    }
...
public static String chooseFile(String choosertitle, File workspacePath, String fileExtension) {
    ...
    public static void main(String[] args) {
    	RegressionGUI1 window = new RegressionGUI1();
